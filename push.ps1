...
try {
    $resp = Invoke-RestMethod -Uri "https://api.github.com/repos/qianye991203-crypto/hotpulse/contents/index.html" -Method PUT -Headers $headers -Body $bytes -TimeoutSec 30
